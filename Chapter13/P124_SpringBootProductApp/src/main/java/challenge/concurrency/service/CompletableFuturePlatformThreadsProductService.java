...
@Service
public class CompletableFuturePlatformThreadsProductService {

    private static final Logger logger = Logger.getLogger(CompletableFuturePlatformThreadsProductService.class.getName());
   
    private final ProductRepository productRepository;

    public CompletableFuturePlatformThreadsProductService(ProductRepository productRepository) {

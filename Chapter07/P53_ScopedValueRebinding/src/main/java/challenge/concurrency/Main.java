...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Runnable runnableTask2 = () -> {
            ...
            ScopedValue.where(SV, "Bumfuzzle-3").run(runnableTask3); // re-rebind
        ...
        Runnable runnableTask1 = () -> {
            ...
            ScopedValue.where(SV, "Bumfuzzle-2").run(runnableTask2); // rebind
        ...
        Thread vt = Thread.ofVirtual().start(() -> {                 
                 ScopedValue.where(SV, "Bumfuzzle-1").run(runnableTask1);                                  
        });                 

...
public final class Conveyor {
    ...
    private static final SynchronousQueue<String> batteryQueue = new SynchronousQueue<>();

    private static final int MAXIMUM_CHARGING_TIME = 2 * 1000;
    private static final int MAXIMUM_DRAINING_TIME = 2 * 1000;

    private static final int OFFER_TIMEOUT = MAXIMUM_DRAINING_TIME + 1000;
        ...
        public void run() {
            while (chargerOn) {
                try {
                    ...
                    boolean success = batteryQueue.offer(
                            battery, OFFER_TIMEOUT, TimeUnit.MILLISECONDS);
